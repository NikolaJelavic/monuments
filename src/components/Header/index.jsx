...
export default function index() {
    ...
    return(
        <div className="flex">
             <Image src={"/img/monuments/Podgaric/podgaric.jpg"} alt="podgaric"  width={500} height={500}        className="sm:w-1/6  md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Kosmaj/kosmaj.png"} alt="kosmaj"  width={500}  height={500}             className="sm:w-1/6  md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Tjentiste/Tjentiste.png"} alt="tjentiste" width={500} height={500}      className="sm:w-1/6  md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Ilirska Bistrica/ilirskaBistrica.png"}  width={500} height={500}        className="sm:w-1/6  md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"      alt="ilirskaBistrica"/>
             <Image src={"/img/monuments/Sisak/sisak.png"} alt="sisak" width={500}   height={500}                className="sm:w-1/6  md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Lepoglava/lepoglava.jpg"} alt="lepoglava" width={500}   height={500}    className="sm:w-1/6  md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Kozara/kozara.png"} alt="kozara" width={500}  height={500}              className="sm:hidden md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Kragujevac/sumarice.jpg"} alt="sumarice" width={500}  height={500}      className="sm:hidden md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Botun/botun.jpg"} alt="botun" width={500}   height={500}                className="sm:hidden md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Belcista/belcista.jpg"} alt="belcista" width={500}   height={500}       className="sm:hidden md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Lukovdol/lukovDol.jpg"} alt="lukovdol" width={500}   height={500}       className="sm:hidden md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline"/>
             <Image src={"/img/monuments/Obadov Brijeg/obadovBrijeg1.jpg"}  width={500}  height={500}            className="sm:hidden md:w-1/12 lg:w-1/12  h-20  md:inline lg:inline" alt="obadov brijeg"/>
        </div>
            )
        };
