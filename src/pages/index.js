...
export default function Home() {
  ...
  <div className="w-full sm:w-3/4">
    <h2 className="text-center text-4xl sm:text-5xl m-5">
      Why was this web presentation made?
    </h2>
    <p className="text-center m-1 text-xl sm:text-2xl">
  ...
  <div className="w-full sm:w-3/4">
    <h2 className="text-center text-4xl sm:text-5xl m-5">Special thanks</h2>
    <p className="text-center m-4 text-2xl sm:text-3xl">
    ...
    <div className="text-center m-4 text-2xl sm:text-3xl">
